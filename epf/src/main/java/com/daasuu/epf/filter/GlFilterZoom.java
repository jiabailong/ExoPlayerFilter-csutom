...
public class GlFilterZoom {
    ...
    public GlFilterZoom(final Resources res, final int vertexShaderSourceResId, final int fragmentShaderSourceResId) {
        this(res.getString(vertexShaderSourceResId), res.getString(fragmentShaderSourceResId));
    }

    public GlFilterZoom(final String vertexShaderSource, final String fragmentShaderSource) {
